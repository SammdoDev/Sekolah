...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['tambah_jurusan'])) {
    $namaAgama = trim($_POST['agama']);

    if (!empty($namaJurusan)) {
        $insertQuery = "INSERT INTO jurusan (namajurusan) VALUES ('$namaAgama')";
                            ...
                            <div class="card mb-4">
                                <div class="card">
                                    <div class="card-header bg-primary text-white">
                                        <h3 class="card-title mb-0">Tabel Siswa SMK Negeri 6</h3>
                                    </div>
                                    <!-- /.card-header -->
                                                ...
                                                <?php while ($row = mysqli_fetch_assoc($resultAgama)): ?>
                                                    <tr class="border-b hover:bg-gray-100">
                                                        ...
                                                        <td class="p-3 text-center">
                                                            <a href="hapus_jurusan.php?kodeAgama=<?= $row['kodeagama']; ?>"
